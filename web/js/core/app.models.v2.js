    ...
    const Models = {
        ...
        async loadModels() {
            ...
            try {
                ...
                // 获取已下载的模型
                const downloadedModels = allModels.filter(m => m.isDownloaded);
        ...
        renderModelCards(models) {
            ...
            grid.innerHTML = sortedModels.map(model => {
                ...
                const statusText = isDownloaded ? '已下载' : '未下载';
                const statusClass = isDownloaded ? 'status-downloaded' : 'status-not-downloaded';
